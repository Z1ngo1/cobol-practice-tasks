      ...
      *   IF YEAR_SALES >= 150000 -> BONUS * 1.05 (HIGHSAL BOOST)      *
      *   IF NEW_BONUS > 20000    -> CAP AT 20000                      *
      *   STATUS: HIGHSAL / CAP / LOW (<2000) / OK                     *
      *   COMMIT EVERY 50 RECORDS, FINAL COMMIT ON CLOSE               *
      ...
      *                                                                *
      * DB2 OBJECTS:                                                   *
      * TB_SALES_BONUS - SALES BONUS TABLE (SOURCE/TARGET)             *
      * DCLGEN: TASK8  - HOST VARIABLE DECLARATIONS                    *
      *                                                                *
      * OUTPUT: OUTDD (REPORT.FILE) - BONUS CHANGE REPORT (PS, 80 B)   *
      ******************************************************************
      ...
      **********************************************                    
      * OPENS REPORT FILE AND CURSOR, PROCESSES ALL ROWS,               
      * THEN CALLS CLOSE-FILES FOR FINAL COMMIT AND SUMMARY REPORT.     
      **********************************************                    
       PROCEDURE DIVISION.                                              
       MAIN-LOGIC.                                                      
      ...
      **********************************************                    
      * OPENS REPORT FILE, WRITES HEADER LINE,                          
      * AND OPENS DB2 CURSOR FOR PROCESSING.                            
      **********************************************                    
       OPEN-FILES.                                                      
      ...
      * WRITES SUMMARY LINE AND DISPLAYS TOTAL COUNT.                   
      **********************************************                    
       CLOSE-FILES.                                                     
           EXEC SQL                                                     
             COMMIT WORK                                                
           ...
           EXEC SQL                                                     
             CLOSE CUR-BONUS                                            
           END-EXEC.                                                    
      * SQLCODE -501 = CURSOR ALREADY CLOSED, NOT AN ERROR.             
      ...
      **********************************************                    
      * FETCHES NEXT ROW FROM CUR-BONUS.                                
      * SQLCODE 0 -> CONTINUE, 100 -> EOF,                              
      * OTHER -> ROLLBACK AND STOP.                                     
      **********************************************                    
       FETCH-EMPLOYEE.                                                  
           EXEC SQL                                                     
      ...
      **********************************************                    
      * APPLIES REGION RATE, HIGHSAL BOOST AND CAP,                     
      * UPDATES CURRENT ROW VIA CURSOR, WRITES                          
      * REPORT LINE, COMMITS EVERY 50 RECORDS.                          
      **********************************************                    
       PROCESS-BONUS.                                                   
           ...
           EVALUATE TRUE                                                
               ...
               WHEN OTHER                                               
                 DISPLAY 'UNKNOWN REGION: ' REGION-CODE OF              
                          DCLTB-SALES-BONUS                             
                 EXEC SQL                                               
                   ROLLBACK WORK                                        
                 END-EXEC                                               
      ...
      **********************************************                    
      * COMMITS CURRENT UNIT OF WORK AND RESETS                         
      * COMMIT-COUNT. ROLLBACK AND STOP ON ERROR.                       
      **********************************************                    
       INTERMEDIATE-COMMIT.                                             
           EXEC SQL                                                     
             COMMIT WORK                                                
      ...
      **********************************************                    
      * FORMATS EMP-ID, REGION, OLD AND NEW BONUS,                      
      * STATUS INTO REPORT LINE AND WRITES TO FILE.                     
      **********************************************                    
       WRITE-REPORT-LINE.                                               
