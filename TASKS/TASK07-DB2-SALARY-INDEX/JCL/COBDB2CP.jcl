...
//DELDD    DD  DSN=Z73460.TASK7.SALARY.REPORT,                          
//             SPACE=(TRK,(1,0),RLSE),                                
//             DISP=(MOD,DELETE,DELETE)                                 
//*=====================================================================
//* STEP 2: COBOL COMPILATION WITH DB2 PRECOMPILE                       
//*=====================================================================
//COMPIL   EXEC DB2CBL,MBR=DB2TASK7                                     
//COBOL.SYSIN  DD DSN=Z73460.COB.PRAC(DB2TASK7),DISP=SHR                
...
//OUTDD    DD DSN=Z73460.TASK7.SALARY.REPORT,                           
...
//SYSTSIN  DD *                                                         
  DSN SYSTEM(DBDG)                                                      
  RUN PROGRAM(DB2TASK7) PLAN(Z73460) -                                  
      LIB('Z73460.LOAD')                                                
  END                                                                   
/*                                          
