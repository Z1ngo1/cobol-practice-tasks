      ...
      *   IF NEW_SALARY > 100000 THEN CAP AT 100000                    *
      *   COMMIT EVERY 100 RECORDS FOR OPTIMAL PERFORMANCE             *
      *                                                                *
      * AUTHOR: STANISLAV                                              *
      * DATE: 2025/12/21                                               *
      *                                                                *
      * DB2:    TB_EMP_SALARY - EMPLOYEE SALARY TABLE (SOURCE/TARGET)  *
      * OUTPUT: OUTDD (REPORT.FILE) - SALARY CHANGE REPORT(PS,80 BYTES)*
      ******************************************************************
      ...
      **********************************************                    
      * CALCULATE NEW SALARY AND UPDATE DB2                             
      **********************************************                    
