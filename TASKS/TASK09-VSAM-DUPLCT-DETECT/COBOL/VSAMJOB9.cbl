      ...
      *                                                                *
      * BUSINESS LOGIC:                                                *
      *   1. SORT CLIENT RECORDS BY NAME (ASC) AND BIRTHDATE (ASC)     *
      *   2. GROUP CONSECUTIVE RECORDS WITH SAME NAME + BIRTHDATE      *
      *   3. IF GROUP SIZE > 1, WRITE ALL RECORDS IN GROUP TO REPORT   *
      *   4. GENERATE SUMMARY: TOTAL RECORDS, GROUPS, DUPLICATES       *
      *                                                                *
      * AUTHOR: STANISLAV                                              *
      * DATE: 2025/12/25                                               *
      *                                                                *
      ...
      * FORMATTED REPORT LINE FOR OUTPUT                                
       01 WS-REPORT-LINE.                                               
          ...
          05 FILLER PIC X(1) VALUE SPACE.                               
          05 WS-CL-PSSPRT PIC X(10).                                    
          05 FILLER PIC X(23) VALUE SPACES.                             
                                                                        
      **********************************************                    
      * MAIN FLOW: SORT -> DETECT -> REPORT                             
      **********************************************                    
       PROCEDURE DIVISION.                                              
       MAIN-LOGIC.                                                      
      ...
      **********************************************                    
      * PROCESS SORTED RECORDS AND DETECT DUPLICATES                    
      **********************************************                    
       PRCSS-SORT-REC.                                                  
      ...
      **********************************************                    
      * ADD CURRENT RECORD TO GROUP BUFFER                              
      **********************************************                    
       ADD-TO-GROUP-BUFFER.                                             
           ...
           IF WS-GROUP-COUNT <= 50                                      
              ...
              MOVE SRT-PSSPRT TO G-PSSPRT(WS-GROUP-COUNT)               
           ELSE                                                         
      ...
      **********************************************                    
      * WRITE DUPLICATE GROUP TO REPORT IF SIZE > 1                     
      **********************************************                    
       WRITE-DUPLICATE-GROUP.                                           
           IF WS-GROUP-COUNT > 1                                        
              ...
              PERFORM VARYING WS-INDEX FROM 1 BY 1                      
                 ...
                 MOVE G-PSSPRT(WS-INDEX) TO WS-CL-PSSPRT                
