      ...
      *                                                                *
      * BUSINESS LOGIC:                                                *
      *   READ ORDER RECORD (ORDER-ID, PRODUCT-ID, QUANTITY)           *
      *   RANDOM READ VSAM BY PRODUCT-ID:                              *
      *     FOUND     -> TOTAL-COST = QUANTITY * UNIT-PRICE,           *
      *                  WRITE ENRICHED INVOICE RECORD                 *
      *     NOT FOUND -> LOG ERROR, SKIP INVOICE (STATUS '23')         *
      *     OTHER     -> LOG ERROR, STOP RUN                           *
      *   DISPLAY SUMMARY ON CLOSE                                     *
      *                                                                *
      * AUTHOR: STANISLAV                                              *
      * DATE: 2025/12/27                                               *
      *                                                                *
      * FILES:                                                         *
      * INPUT: VSAMDD (PROD.MASTER) - PRODUCT MASTER FILE (KSDS)       *
      * INPUT: ORDD (ORDERS.DAILY) - DAILY ORDERS FILE (PS, 80 B)      *
      ...
      * CALCULATED TOTAL COST                                           
       01 WS-TOTAL-COST PIC 9(6)V99 COMP-3.                             
                                                                        
      **********************************************                    
      * OPENS ALL FILES, PROCESSES ALL ORDERS,                          
      * CLOSES FILES AND DISPLAYS FINAL SUMMARY.                        
      **********************************************                    
       PROCEDURE DIVISION.                                              
       MAIN-LOGIC.                                                      
      ...
      **********************************************                    
      * READS ORDERS SEQUENTIALLY UNTIL EOF.                            
      * CALLS PROCESS-ORDER FOR EACH RECORD.                            
      **********************************************                    
       PROCESS-ORDERS.                                                  
           PERFORM UNTIL EOF                                            
      ...
      **********************************************                    
      * RANDOM READ VSAM BY PRODUCT-ID. STATUS '00'                     
      * -> WRITE INVOICE. STATUS '23' -> LOG ERROR, SKIP.               
      ...
      **********************************************                    
      * CALCULATES TOTAL COST AND WRITES ENRICHED                       
      * INVOICE RECORD TO OUTPUT FILE.                                  
      **********************************************                    
       WRITE-INVOICE-LINE.                                              
           ...
           MOVE WS-TOTAL-COST TO INVOICE-TOTAL-COST                     
           WRITE OUT-REC.                                               
           IF OUT-STATUS NOT = '00'                                     
