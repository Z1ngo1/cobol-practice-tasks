...
//DELDD    DD  DSN=Z73460.TASK19.SUCCESS.LOG,                           
//             SPACE=(TRK,(1,0),RLSE),                                  
//             DISP=(MOD,DELETE,DELETE)                                 
//*=====================================================================
//* STEP 2: COBOL COMPILATION WITH DB2 PRECOMPILE                       
//*=====================================================================
//COMPIL   EXEC DB2CBL,MBR=DB2JOB19                                     
//COBOL.SYSIN  DD DSN=Z73460.COB.PRAC(DB2JOB19),DISP=SHR                
...
//INDD     DD DSN=Z73460.TASK19.NEW.CUSTOMER,DISP=SHR                   
//OUTDD    DD DSN=Z73460.TASK19.SUCCESS.LOG,                            
